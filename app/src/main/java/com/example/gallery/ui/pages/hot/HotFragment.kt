...
import com.example.gallery.databinding.FragmentHotBinding
...
class HotFragment : BaseFragment(R.layout.fragment_hot) {
    ...
    private val viewModel: HotViewModel by viewModels { factory }
    ...
    private val clearDataListener = View.OnClickListener {
        showAlert(
            ...
            positiveAction = getString(R.string.button_ok) to { viewModel.clearData(Category.HOT) },
